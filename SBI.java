...
public class SBI extends Account {
	...
	public SBI(long accountNumber, String accountHolderName, double balance, long phone, String email, String password,
...
//			setBalance(getBalance() + amount);
//			
//			//trnsHis = trnsHis+"deposite : " +amount+" "+(new Date().toLocaleString())+"\n"
...
//			if(getBalance() > amount) {
//				setBalance(getBalance() - amount);
//				//trnsHis = trnsHis+" withdraw : " +amount+" "+(new Date().toLocaleString())+" \\n"
...
//do {
//	Syso(transaction history)
//}

//case 6:
//{
//	syso(b.transactionHist())
//}break;
